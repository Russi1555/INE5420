...
class MainWindow(QMainWindow):
    ...
    def UiComponents(self):
        ...
        self.tqt.setStyleSheet("QLineEdit"
                                    "{"
                                    "border: 1px solid;"
                                    "border-color: black"
                                    "}")
        ...
        self.sqt.setStyleSheet("QLineEdit"
                                    "{"
                                    "border: 1px solid;"
                                    "border-color: black"
                                    "}")
        ...
        self.rqt.setStyleSheet("QLineEdit"
                                    "{"
                                    "border: 1px solid;"
                                    "border-color: black"
                                    "}")
        ...
        self.center_x.setStyleSheet("QLineEdit"
                                    "{"
                                    "border: 1px solid;"
                                    "border-color: black"
                                    "}")
        ...
        self.center_y.setStyleSheet("QLineEdit"
                                    "{"
                                    "border: 1px solid;"
                                    "border-color: black"
                                    "}")
        ...
        self.render_center_point.setStyleSheet("QCheckBox"
                                    "{"
